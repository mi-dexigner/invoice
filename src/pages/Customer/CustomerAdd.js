import { makeStyles, createStyles,Box, Grid, InputAdornment, Input, InputLabel, FormControl, Select } from '@material-ui/core'
...
const CustomerAdd = () => {
    ...
    return (
        <Layout title="Add Customer">
              ...
              <Box component="div" className="border paddingLeftRight" mb={2}>
        ...
        />
             ...
             {/* end companyLogo field */}
              ...
              <Grid item md={6} spacing={3}>
              <Box component="div" className="border paddingLeftRight" mb={2}>2</Box>
              <Box component="div" className="border paddingLeftRight" mb={2}>3</Box>
